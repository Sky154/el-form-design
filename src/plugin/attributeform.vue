      ...
      <el-tab-pane label="字段设置" name="1">
        <el-form :model="form" label-width="80px" size='small'>
          ...
          <el-form-item v-if='form.showFrom.indexOf("prefixicon") !== -1' label="头部图标">
            ...
            <e-icon-picker v-model="form.prefixicon" :options="options"/>
          </el-form-item>
          <el-form-item v-if='form.showFrom.indexOf("suffixicon") !== -1' label="尾部图标">
           <!-- <el-input v-model="form.suffixicon"></el-input> -->
            <e-icon-picker v-model="form.suffixicon" :options="options"/>
          </el-form-item>
          ...
          <!-- 图片 -->
          <el-form-item v-if='form.showFrom.indexOf("src") !== -1' label="图片地址">
            <el-input placeholder="请输入图片地址" prefix-icon="el-icon-link" v-model="form.src" />
          </el-form-item>
          <el-form-item v-if='form.showFrom.indexOf("fit") !== -1' label="适应方式">
            <el-select style="width:100%" v-model="form.fit" placeholder="请选择">
              <el-option label="拉伸" value="fill"></el-option>
              <el-option label="内容缩放" value="contain"></el-option>
              <el-option label="保持原比例" value="cover"></el-option>
              <el-option label="保持原尺寸" value="none"></el-option>
              <el-option label="适应内容" value="scale-down"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item v-if='form.showFrom.indexOf("imageWidth") !== -1' label="图片宽">
            <el-input-number :min="1" :max="1000" v-model="form.imageWidth"></el-input-number>
          </el-form-item>
          <el-form-item v-if='form.showFrom.indexOf("imageHeight") !== -1' label="图片高">
            <el-input-number :min="1" :max="1000" v-model="form.imageHeight"></el-input-number>
          </el-form-item>
        </el-form>
      </el-tab-pane>
